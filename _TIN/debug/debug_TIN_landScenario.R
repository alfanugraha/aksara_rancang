...
##scenario 1 : rehabilitasi lahan dgn skema hutan rakyat
scenario1=readRDS("_DB/skenarioData/Jabar/lahan/dw_JaBar_2020-04-23_16-21-44_rehabilitasilahandenganskemahutantanamanrakyat") #external input
scenarioFD1= scenario1$fdSelisih
scenarioInputLandCover1=scenario1$satSelisih

##scenario 2 : perlindungan hutan
scenario2=readRDS("_DB/skenarioData/Jabar/lahan/dw_JaBar_2020-04-23_16-27-41_PerlindunganHutan") #external input
scenarioFD2= scenario2$fdSelisih
scenarioInputLandCover2=scenario2$satSelisih
  
##scenario 3 : combination of scen 1 & 2
scenarioFD3<-scenarioFD1
scenarioFD3[,2:ncol(scenarioFD1)]<-scenarioFD1[,2:ncol(scenarioFD1)]
scenarioInputLandCover3= rbind(scenarioInputLandCover1,scenarioInputLandCover2)
scenarioInputLandCover3<-aggregate(scenarioInputLandCover3[,3:ncol(scenarioInputLandCover3)], by=list(scenarioInputLandCover3$tutupan.lahan.awal,scenarioInputLandCover3$tutupan.lahan.akhir), FUN=sum)




scenarioFD=scenarioFD1
scenarioInputLandCover=scenarioInputLandCover1
...
##### Save CSV ####
# write.csv(scenarioResultEnergyConsumption,"_TIN/debug/scenarioResultEnergyConsumption1.csv")
# write.csv(scenarioResultEnergyEmission,"_TIN/debug/scenarioResultEnergyEmission1.csv")
# write.csv(scenarioResultFertilizerEmission,"_TIN/debug/scenarioResultFertilizerEmission1.csv")
# write.csv(scenarioResultFertilizerUsed,"_TIN/debug/scenarioResultFeltilizerUsed1.csv")
# write.csv(scenarioResultLandCover,"_TIN/debug/scenarioResultLandCover1.csv")
# write.csv(scenarioResultLandEmission,"_TIN/debug/scenarioResultLandEmission1.csv")
# write.csv(scenarioResultLandReq,"_TIN/debug/scenarioResultLandReq1.csv")
# write.csv(scenarioResultLUTM,"_TIN/debug/scenarioResultLUTM1.csv")
# write.csv(scenarioResultWasteDisposal,"_TIN/debug/scenarioResultWasteDisposal1.csv")
# write.csv(scenarioResultWasteEmission,"_TIN/debug/scenarioResultWasteEmission1.csv")
# write.csv(scenarioResultTotalEmission,"_TIN/debug/scenarioResultTotalEmission1.csv")
# write.csv(scenarioResultGDP,"_TIN/debug/scenarioResultGDP1.csv")
# write.csv(scenarioResultIncome,"_TIN/debug/scenarioResultIncome1.csv")
# write.csv(scenarioResultIncomePerCapita,"_TIN/debug/scenarioResultIncomePerCapita1.csv")
# write.csv(scenarioResultLabour,"_TIN/debug/scenarioResultLabour1.csv")

# write.csv(scenarioResultEnergyConsumption,"_TIN/debug/scenarioResultEnergyConsumption2.csv")
# write.csv(scenarioResultEnergyEmission,"_TIN/debug/scenarioResultEnergyEmission2.csv")
# write.csv(scenarioResultFertilizerEmission,"_TIN/debug/scenarioResultFertilizerEmission2.csv")
# write.csv(scenarioResultFertilizerUsed,"_TIN/debug/scenarioResultFeltilizerUsed2.csv")
# write.csv(scenarioResultLandCover,"_TIN/debug/scenarioResultLandCover2.csv")
# write.csv(scenarioResultLandEmission,"_TIN/debug/scenarioResultLandEmission2.csv")
# write.csv(scenarioResultLandReq,"_TIN/debug/scenarioResultLandReq2.csv")
# write.csv(scenarioResultLUTM,"_TIN/debug/scenarioResultLUTM2.csv")
# write.csv(scenarioResultWasteDisposal,"_TIN/debug/scenarioResultWasteDisposal2.csv")
# write.csv(scenarioResultWasteEmission,"_TIN/debug/scenarioResultWasteEmission2.csv")
# write.csv(scenarioResultTotalEmission,"_TIN/debug/scenarioResultTotalEmission2.csv")
# write.csv(scenarioResultGDP,"_TIN/debug/scenarioResultGDP2.csv")
# write.csv(scenarioResultIncome,"_TIN/debug/scenarioResultIncome2.csv")
# write.csv(scenarioResultIncomePerCapita,"_TIN/debug/scenarioResultIncomePerCapita2.csv")
# write.csv(scenarioResultLabour,"_TIN/debug/scenarioResultLabour2.csv")

# write.csv(scenarioResultEnergyConsumption,"_TIN/debug/scenarioResultEnergyConsumption3.csv")
# write.csv(scenarioResultEnergyEmission,"_TIN/debug/scenarioResultEnergyEmission3.csv")
# write.csv(scenarioResultFertilizerEmission,"_TIN/debug/scenarioResultFertilizerEmission3.csv")
# write.csv(scenarioResultFertilizerUsed,"_TIN/debug/scenarioResultFeltilizerUsed3.csv")
# write.csv(scenarioResultLandCover,"_TIN/debug/scenarioResultLandCover3.csv")
# write.csv(scenarioResultLandEmission,"_TIN/debug/scenarioResultLandEmission3.csv")
# write.csv(scenarioResultLandReq,"_TIN/debug/scenarioResultLandReq3.csv")
# write.csv(scenarioResultLUTM,"_TIN/debug/scenarioResultLUTM3.csv")
# write.csv(scenarioResultWasteDisposal,"_TIN/debug/scenarioResultWasteDisposal3.csv")
# write.csv(scenarioResultWasteEmission,"_TIN/debug/scenarioResultWasteEmission3.csv")
# write.csv(scenarioResultTotalEmission,"_TIN/debug/scenarioResultTotalEmission3.csv")
# write.csv(scenarioResultGDP,"_TIN/debug/scenarioResultGDP3.csv")
# write.csv(scenarioResultIncome,"_TIN/debug/scenarioResultIncome3.csv")
# write.csv(scenarioResultIncomePerCapita,"_TIN/debug/scenarioResultIncomePerCapita3.csv")
# write.csv(scenarioResultLabour,"_TIN/debug/scenarioResultLabour3.csv")
# 
# write.csv(resultEnergyConsumption,"_TIN/debug/resultEnergyConsumption.csv")
# write.csv(resultEnergyEmission,"_TIN/debug/resultEnergyEmission.csv")
# write.csv(resultFertilizerEmission,"_TIN/debug/resultFertilizerEmission.csv")
# write.csv(resultFertilizerUsed,"_TIN/debug/resultFeltilizerUsed.csv")
# write.csv(resultLandCover,"_TIN/debug/resultLandCover.csv")
# write.csv(resultLandEmission,"_TIN/debug/resultLandEmission.csv")
# write.csv(resultLandReq,"_TIN/debug/resultLandReq.csv")
# write.csv(resultLUTM,"_TIN/debug/resultLUTM.csv")
# write.csv(resultWasteDisposal,"_TIN/debug/resultWasteDisposal.csv")
# write.csv(resultWasteEmission,"_TIN/debug/resultWasteEmission.csv")
# write.csv(resultTotalEmission,"_TIN/debug/resultTotalEmission.csv")
# write.csv(resultGDP,"_TIN/debug/resultGDP.csv")
# write.csv(resultIncome,"_TIN/debug/resultIncome.csv")
# write.csv(resultIncomePerCapita,"_TIN/debug/resultIncomePerCapita.csv")
# write.csv(resultLabour,"_TIN/debug/resultLabour.csv")

##### test if scenarioResult3 = BAUResult + delta scenarioResult1 + delta scenarioResult 2 ##### 
