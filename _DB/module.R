...
buttonModule <- function(input, output, session, data, type) {
      ...
      showModal(
        modalDialog( 
          ...
          tabsetPanel(
            ...
            ################################################################################
            #                                                                              #
            #                        BUTTON KONSTRUKSI AKUN SATELIT LAHAN                  #
            #                                                                              #
            ################################################################################
            tabPanel(
              h2("Akun satelit lahan"),
              sidebarLayout(
                sidebarPanel(
                  fluidPage(
  ...
  ################################################################################
  #                                                                              #
  #                   ALUR BUTTON KONSTRUKSI AKUN SATELIT                        #
  #                                                                              #
  ################################################################################
...
# ## END Land -------------------------------------------------------------
  ...
  observeEvent(input$saveModalSat,{
    ...
    satSelisih <- lapply(satSelisih, function(x){
      ...
      textTampil <- paste0("Akun satelit yang diedit adalah ","sektor: ",inputSektorTampil," - ","tahun: ",
